...
dir.create("../External/Oxford/Resulting_data/")
for(x in popVec){
  print(x)
  locFile_5 <- readRDS(paste0("../External/Oxford/Resulting_data_5_neighbors/", x, "/", x, "_full_file_post_Euclid_5_neighbors.rds"))
  locFile_15 <- readRDS(paste0("../External/Oxford/Resulting_data_15_neighbors/", x, "/", x, "_full_file_post_Euclid.rds"))
  ...
  if(all(identical(locFile_5[,1:10], locFile_15[,1:10]), identical(locFile_5[,1:10], locFile_45[,1:10]))){
    ...
    dir.create(paste0( "../External/Oxford/Resulting_data/", x))
