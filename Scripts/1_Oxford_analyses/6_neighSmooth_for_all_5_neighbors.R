...
library(ClusterR)
library(DepecheR)
dir.create("../External/Oxford/Resulting_data_5_neighbors/")
for(a in popVec){
  print(a)
  dataDir <- paste0("../External/Oxford/Resulting_data_5_neighbors/", a, "/")
  ...
  saveRDS(big_all_file, paste0(dataDir, a, "_full_file_post_Euclid_5_neighbors.rds"))
}